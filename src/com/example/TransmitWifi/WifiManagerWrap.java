...
/**
 * wrap wifi manager to adapter app
 * @author haihui.li
 * @version 1.0.0
 */
public class WifiManagerWrap {
    private static final String TAG = "WifiManagerWrap";
    /**无密码类型*/
    ...
    /**网络id前缀*/
    public static final String SSID_PREFIX = "TF";
    /**默认的网络id*/
    public static final String DEFAULT_SSID = SSID_PREFIX;
    /**默认的密码*/
    public static final String DEFAULT_PASSWORD = "wifipass";
    /**
     * To follow the limit of the max character length is 32 as a wifi access name
     */
